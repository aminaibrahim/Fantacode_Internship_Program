...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CarouselView.FormsPlugin.Android.VerticalViewPager+VerticalPageTransformer, CarouselView.FormsPlugin.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", VerticalViewPager_VerticalPageTransformer.class, __md_methods);
	}
	...
	public VerticalViewPager_VerticalPageTransformer ()
	{
		...
		if (getClass () == VerticalViewPager_VerticalPageTransformer.class)
			mono.android.TypeManager.Activate ("CarouselView.FormsPlugin.Android.VerticalViewPager+VerticalPageTransformer, CarouselView.FormsPlugin.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
