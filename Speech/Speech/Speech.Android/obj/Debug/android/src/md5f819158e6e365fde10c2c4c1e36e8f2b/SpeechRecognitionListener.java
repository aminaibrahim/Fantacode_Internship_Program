package md5f819158e6e365fde10c2c4c1e36e8f2b;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.SpeechRecognition.SpeechRecognitionListener, Plugin.SpeechRecognition, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", SpeechRecognitionListener.class, __md_methods);
	}
	...
	public SpeechRecognitionListener ()
	{
		...
		if (getClass () == SpeechRecognitionListener.class)
			mono.android.TypeManager.Activate ("Plugin.SpeechRecognition.SpeechRecognitionListener, Plugin.SpeechRecognition, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
